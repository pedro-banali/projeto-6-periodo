...
import br.pucpr.bsi.prog6.ticketsAereosBSI.tests.laboratorioModel.TesteExecutivaLabModel;
...
public class TesteExecutivaLabBC extends TesteExecutivaLabModel {
	...
	public void validarBilheteNulo(){
		...
		ExecutivaBC.getInstance().insert(bilhete);
	}
